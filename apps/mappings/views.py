...
from .forms import DetailSegmentAssignmentForm, SegmentFormSet, SubSegmentFormSet, DetailSegmentFormSet
from .models import Segment, SubSegment, DetailSegment
...
class SegmentMappingTableView(LoginRequiredMixin, UserPropertyAccessMixin, TemplateView):
    template_name = "segments/mapping_table.html"
    ...
    def post(self, request, *args, **kwargs):
        ...
        if formset.is_valid():
            ...
            return redirect(f"{reverse('segments:mapping-table')}?property={selected_property.id}")
...
class SubSegmentMappingTableView(SegmentMappingTableView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if formset.is_valid():
            ...
            messages.success(request, f"{self.title} updated successfully.")
            return redirect(f"{reverse('segments:subsegment-mapping-table')}?property={selected_property.id}")
...
class DetailSegmentMappingTableView(SegmentMappingTableView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if formset.is_valid():
            ...
            messages.success(request, f"{self.title} updated successfully.")
            return redirect(f"{reverse('segments:detailsegment-mapping-table')}?property={selected_property.id}")
...
class DetailSegmentCreateView(LoginRequiredMixin, UserPropertyAccessMixin, CreateView):
    ...
    template_name = "segments/detailsegment_assignment_form.html"
    ...
    def get_success_url(self):
        ...
        return reverse("segments:group-list") + f"?property={property_id}"
...
#     model = SegmentGroup
#     template_name = "segments/group_list.html"
...
#     template_name = "segments/group_form.html"
...
#     def get_success_url(self):
#         return reverse("segments:group-list") + f"?property={self.get_selected_property().id}"
...
#     def get_success_url(self):
#         return reverse("segments:group-list") + f"?property={self.object.property_id}"
    

# class SegmentGroupDeleteView(LoginRequiredMixin, UserPropertyAccessMixin, DeleteView):
#     model = SegmentGroup
#     template_name = "segments/group_confirm_delete.html"
...
#     template_name = "segments/segment_form.html"
...
#     def get_success_url(self):
#         return reverse("segments:group-list") + f"?property={self.object.property.id}"


# class SegmentDeleteView(LoginRequiredMixin, UserPropertyAccessMixin, DeleteView):
#     model = Segment
#     template_name = "segments/segment_confirm_delete.html"
...
#     template_name = "segments/subsegment_form.html"
...
#     model = SubSegment
#     template_name = "segments/subsegment_confirm_delete.html"
...
#     template_name = "segments/detailsegment_form.html"
...
#     model = DetailSegment
#     template_name = "segments/detailsegment_confirm_delete.html"
