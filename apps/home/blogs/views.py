...
# from blogs.forms import BLogCategoryForm, ArticleForm
...
#     return render(request, 'blogs/admin/dashboard.html')
...
#     return render(request, 'blogs/admin/user_list.html',
...
#     return render(
#         request, 'blogs/admin/blog_list.html', {'blogs_list': blogs_list, 'pages_list': pages_list})
...
#         return render(request, 'blogs/admin/blog_new.html', {'category': category_list, 'form': form.errors, 'tags': tags})
#     return render(request, 'blogs/admin/blog_new.html', {'category': category_list, 'tags': tags})
...
#                     blog.tags.add(tag)
#             return redirect('blogs:blog_list')
#         return render(request, 'blogs/admin/blog_edit.html', {'form': form.errors, 'blog': blog_content, 'category': category_list, 'tags': tags})
#     return render(request, 'blogs/admin/blog_edit.html', {'blog': blog_content, 'category': category_list, 'tags': tags})
...
#     return render(request, 'blogs/admin/blog_category_list.html', {'blogdata': blog, 'list_length': length})
...
#             blog.is_active = True
#             blog.save()
#             return redirect('blogs:blog_category_list')
#         return render(request, 'blogs/admin/blog_category_create.html', {'form': form.errors
#                                                                                   })
#     return render(request, 'blogs/admin/blog_category_create.html')
...
#             form.save()
#             return redirect('blogs:blog_category_list')
#         return render(request, 'blogs/admin/blog_category_edit.html',
#                       {'form': form.errors, 'blog_data': blog})
#     return render(request, 'blogs/admin/blog_category_edit.html', {'blog_data': blog})
...
#             blog.is_page = True
#             blog.save()
#             return redirect('blogs:page_category_list')
#         return render(request, 'blogs/admin/page_category.html', {'form': form.errors
#                                                                            })
#     return render(request, 'blogs/admin/page_category.html')


# @login_required
# def blog_detail(request, slug):
#     blog = get_object_or_404(Article, slug=slug, is_page=False)
#     return render(request, 'blogs/blog/blog.html', {'data': blog})


# @login_required
# def blog_preview(request, pk):
#     blog = get_object_or_404(Article, id=pk)
#     return render(request, 'blogs/admin/preview.html', {'data': blog})


# @login_required
# def page_detail(request, slug):
#     blog = get_object_or_404(Article, slug=slug, is_page=True)
#     return render(request, 'blogs/page/page.html', {'data': blog})
...
#             "blogs:get_blog_content", kwargs={"pk": pk}
#         )
#         return render(
#             request,
#             "blogs/admin/grape_js.html",
...
#             blog.save()
#         url = reverse("blogs:blog_edit", kwargs={"pk": pk})
...
#         return render(
#             request,
#             "blogs/admin/ckeditor.html", {"blog": blog}
#         )
#     if request.method == "POST":
