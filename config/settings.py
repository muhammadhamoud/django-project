...
DEBUG = EXTENDED_DEBUG

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/4.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
# SECRET_KEY = 'django-insecure-s$p72f2zn3lhmr+of1c_#ct=6(z1v=dj%+j5f-$e(wf+8j+=*+'
...
ALLOWED_HOSTS = EXTENDED_ALLOWED_HOSTS
...
# # SECURITY WARNING: keep the secret key used in production secret!
# SECRET_KEY = "django-insecure-uspdn+&-%v_sxhhlgiq8tz@dn&d@43rpv_p9za0d$co*m@p_g4"
